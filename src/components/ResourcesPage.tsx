...
import { ArrowRight, ArrowSquareOut, Calendar, DownloadSimple, FileText, CheckCircle, Users as UsersIcon, CalendarBlank, PaperPlaneTilt, X, EnvelopeSimple } from "@phosphor-icons/react"
...
function NewsletterSignup({ compact = false }: NewsletterSignupProps) {
        ...
        <div className="max-w-6xl mx-auto">
              ...
              {socialPosts.map((post) => (
                <Card key={post.id} className="hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        <div className={`w-3 h-3 rounded ${getPlatformColor(post.platform)}`} />
          ...
          <div className="mt-12 text-center">
            <div className="flex justify-center gap-4">
              ...
              <Button 
                variant="outline"
                onClick={() => window.open('https://www.instagram.com/dr_dede_', '_blank')}
              >
                Instagram
                <ArrowSquareOut size={16} className="ml-2" />
              </Button>
...
export { ResourcesDownloadsSection, AIGovernanceAssessment, SocialMediaAndEventsSection }